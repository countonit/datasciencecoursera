...
### Subject
Code that represents the subject of the study. A code between 1 and 30 designating the participant.

Data type: Numeric
Values: 1-30

### Activity
Variable that describes the type of activity that the subject was performing.
...
### Sensor Measures
The remaining 79 variables are measures from the sensors on the smartphone.
...
This data set cotains measures for the average of each of the these for a given subject and activity
